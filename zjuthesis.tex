...
\documentclass[
    ...
    % Title
    Title           = 基于区块链的物联网时序数据高效可信存储技术研究,
    TitleEng        = {Research on Efficient and Trusted Storage Technology for Time Series Data in the Internet of Things Based on Blockchain}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{基于区块链的物联网时序数据}{高效可信存储技术研究}
...
\titleengthreelines{Research on Efficient and Trusted Storage}{Technology for Time Series Data in the}{Internet of Things Based on Blockchain}
