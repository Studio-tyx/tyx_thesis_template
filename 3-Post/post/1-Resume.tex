...
\begin{enumerate}[label={[\arabic*]},leftmargin=*]
    ...
    % \item Wenzhao Zhang, Jiamei Lv, Renjie Li, Yongqi Chen, \textbf{Yixiao Teng}, Yi Gao, Wei Dong, Elink: Enabling Realtime Processing of Massive IoT Data by Edge-Cloud Collaborative Stream Computing, to be submitted to IEEE RTSS 2025. [CCF A类会议]\\
\end{enumerate}
